...
public class ZebreIntension {
    ...
    public static void main(String[] args) {
        ...
        model.or(model.arithm(che, "=", fox, "+", 1), model.arithm(che, "=", fox, "-", 1)).post();
        model.or(model.arithm(koo, "=", hor, "+", 1), model.arithm(koo, "=", hor, "-", 1)).post();
        model.arithm(luc, "=", ora).post();
        model.arithm(jap, "=", par).post();
        model.or(model.arithm(nor, "=", blu, "+", 1), model.arithm(nor, "=", blu, "-", 1)).post();
