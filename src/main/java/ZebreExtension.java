...
public class ZebreExtension {
    ...
    public static void main(String[] args) {
        ...
        Tuples tuplesAutorises0 = new Tuples(validTuples, true); // true indique que ce sont les valeurs autorisées

        model.table(new IntVar[]{ivo, gre}, tuplesAutorises0).post(); //6
        ...
        int[][] validTuples1 = {{3}};
        Tuples tuplesAutorises1 = new Tuples(validTuples1, true);
        model.table(new IntVar[]{mil}, tuplesAutorises1).post(); //9


        int[][] validTuples2 = {{1}};
        Tuples tuplesAutorises2 = new Tuples(validTuples2, true);
        model.table(new IntVar[]{nor}, tuplesAutorises2).post(); //10
        ...
        Tuples tuplesAutorises3 = new Tuples(validTuples3, true);
        model.table(new IntVar[]{fox, che}, tuplesAutorises3).post();//11
        ...
        Tuples tuplesAutorises4 = new Tuples(validTuples4, true);
        model.table(new IntVar[]{hor, koo}, tuplesAutorises4).post();//12
        ...
        Tuples tuplesAutorises5 = new Tuples(validTuples5, true);
        model.table(new IntVar[]{blu, nor}, tuplesAutorises5).post(); //15
